...
d.render_svg("diagrams/Autograd/autograd1.svg", 20)
...
d.render_svg("diagrams/Autograd/autograd2.svg", 20)

d = left_arrow.named("out") | bbox | left_arrow.named("in")
d += label_above(d, "out", ta("f'(x)"))
d += label_above(d, "in", ta("d_out"))

d.render_svg("diagrams/Autograd/autograd3.svg", 20)
...
d.render_svg("diagrams/Autograd/autograd4.svg", 20)
...
d.render_svg("diagrams/Autograd/autograd5.svg", 20)
...
d.render_svg("diagrams/Autograd/chain1.svg", 20)
